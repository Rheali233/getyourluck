...
('psychology', '心理健康测试', '揭秘你的性格密码', '🧠', 'psychology', 1200, 4.8, 1, '/tests/psychology', '["MBTI", "抑郁", "情商"]', '3-5分钟', 1),
('astrology', '星座运势分析', '今日运势早知道', '⭐', 'astrology', 2100, 4.7, 1, '/tests/astrology', '["星座配对", "运势"]', '1-2分钟', 2),
('tarot', '塔罗牌占卜', '神秘塔罗解心事', '🔮', 'tarot', 890, 4.6, 1, '/tests/tarot', '["在线抽牌", "解读"]', '2-3分钟', 3),
('career', '职业规划测试', '找到最适合的工作', '📊', 'career', 1500, 4.9, 1, '/tests/career', '["霍兰德", "DISC测试"]', '5-8分钟', 4),
('numerology', '传统命理分析', '算出你的好运气', '🧮', 'numerology', 756, 4.5, 1, '/tests/numerology', '["八字", "生肖", "姓名"]', '3-5分钟', 5),
('learning', '学习能力评估', '发现学习超能力', '📚', 'learning', 980, 4.7, 1, '/tests/learning', '["学习风格", "认知能力"]', '4-6分钟', 6),
('relationship', '情感关系测试', '了解你的爱情密码', '💕', 'relationship', 1340, 4.8, 1, '/tests/relationship', '["恋爱类型", "沟通方式"]', '3-5分钟', 7);
