    ...
    async createBatch(events) {
        ...
        for (const eventData of events) {
            ...
            const ipAddressHash = eventData.ipAddress
                ...
                : null;
            values.push('(?, ?, ?, ?, ?, ?, ?)');
            params.push(id, eventData.eventType, eventData.eventData ? JSON.stringify(eventData.eventData) : null, eventData.sessionId || null, ipAddressHash, eventData.userAgent || null, now);
        }
        const query = `
      INSERT INTO ${this.tableName} (
        id, event_type, event_data, session_id,
...
//# sourceMappingURL=AnalyticsEventModel.js.map