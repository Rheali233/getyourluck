-- Insert options for all questions in all relationship test categories
-- This script will create 5 Likert scale options for each of the 90 questions
...
SELECT 
    'ls-' || substr(q.id, 25) || '-opt-' || o.option_number as id,
    q.id as question_id,
    o.option_text,
    o.option_value,
    o.option_score,
...
INSERT OR IGNORE INTO psychology_question_options (id, question_id, option_text, option_value, option_score, option_description, order_index, is_correct)
SELECT 
    'll-' || substr(q.id, 28) || '-opt-' || o.option_number as id,
    q.id as question_id,
    o.option_text,
    o.option_value,
    o.option_score,
...
INSERT OR IGNORE INTO psychology_question_options (id, question_id, option_text, option_value, option_score, option_description, order_index, is_correct)
SELECT 
    'ip-' || substr(q.id, 25) || '-opt-' || o.option_number as id,
    q.id as question_id,
    o.option_text,
    o.option_value,
    o.option_score,
