...
export const DateInput: React.FC<DateInputProps> = ({
  ...
  }, [year, month, day]); // 移除 onChange 依赖，避免无限循环
  ...
  return (
    <div className={cn("flex items-center space-x-2 w-full max-w-xs", className)} {...props}>
      ...
      <input
        ...
        disabled={disabled}
        className={cn(
          "w-20 p-3 border border-gray-300 rounded-lg text-center bg-white text-gray-900 placeholder-gray-500",
