      ...
      <div id="mainContent" className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              ...
              <div className="bg-red-50 rounded-lg p-6 text-center border border-red-200">
                ...
                <div className="text-gray-700">
                  <div className="text-base">{UI_TEXT.numerology.bazi.resultPage.pillars.heavenlyStem}: {analysisResult.baZi.yearPillar.heavenlyStem || UI_TEXT.numerology.bazi.resultPage.pillars.notAvailable}</div>
                  <div className="text-base">{UI_TEXT.numerology.bazi.resultPage.pillars.earthlyBranch}: {analysisResult.baZi.yearPillar.earthlyBranch || UI_TEXT.numerology.bazi.resultPage.pillars.notAvailable}</div>
                  <div className="text-base">{UI_TEXT.numerology.bazi.resultPage.pillars.element}: {analysisResult.baZi.yearPillar.element || UI_TEXT.numerology.bazi.resultPage.pillars.notAvailable}</div>
                  <div className="text-base">{UI_TEXT.numerology.bazi.resultPage.pillars.animal}: {analysisResult.baZi.yearPillar.animal || UI_TEXT.numerology.bazi.resultPage.pillars.notAvailable}</div>
                </div>
              </div>
              ...
              <div className="bg-red-50 rounded-lg p-6 text-center border border-red-200">
                ...
                <div className="text-gray-700">
                  <div className="text-base">{UI_TEXT.numerology.bazi.resultPage.pillars.heavenlyStem}: {analysisResult.baZi.monthPillar.heavenlyStem || UI_TEXT.numerology.bazi.resultPage.pillars.notAvailable}</div>
                  <div className="text-base">{UI_TEXT.numerology.bazi.resultPage.pillars.earthlyBranch}: {analysisResult.baZi.monthPillar.earthlyBranch || UI_TEXT.numerology.bazi.resultPage.pillars.notAvailable}</div>
                  <div className="text-base">{UI_TEXT.numerology.bazi.resultPage.pillars.element}: {analysisResult.baZi.monthPillar.element || UI_TEXT.numerology.bazi.resultPage.pillars.notAvailable}</div>
                </div>
              </div>
              ...
              <div className="bg-red-50 rounded-lg p-6 text-center border border-red-200">
                ...
                <div className="text-gray-700">
                  <div className="text-base">{UI_TEXT.numerology.bazi.resultPage.pillars.heavenlyStem}: {analysisResult.baZi.dayPillar.heavenlyStem || UI_TEXT.numerology.bazi.resultPage.pillars.notAvailable}</div>
                  <div className="text-base">{UI_TEXT.numerology.bazi.resultPage.pillars.earthlyBranch}: {analysisResult.baZi.dayPillar.earthlyBranch || UI_TEXT.numerology.bazi.resultPage.pillars.notAvailable}</div>
                  <div className="text-base">{UI_TEXT.numerology.bazi.resultPage.pillars.element}: {analysisResult.baZi.dayPillar.element || UI_TEXT.numerology.bazi.resultPage.pillars.notAvailable}</div>
                </div>
              </div>
              ...
              <div className="bg-red-50 rounded-lg p-6 text-center border border-red-200">
                ...
                <div className="text-gray-700">
                  <div className="text-base">{UI_TEXT.numerology.bazi.resultPage.pillars.heavenlyStem}: {analysisResult.baZi.hourPillar.heavenlyStem || UI_TEXT.numerology.bazi.resultPage.pillars.notAvailable}</div>
                  <div className="text-base">{UI_TEXT.numerology.bazi.resultPage.pillars.earthlyBranch}: {analysisResult.baZi.hourPillar.earthlyBranch || UI_TEXT.numerology.bazi.resultPage.pillars.notAvailable}</div>
                  <div className="text-base">{UI_TEXT.numerology.bazi.resultPage.pillars.element}: {analysisResult.baZi.hourPillar.element || UI_TEXT.numerology.bazi.resultPage.pillars.notAvailable}</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
              {Object.entries(safeFiveElements).map(([element, value]) => {
                ...
                <div key={element} className="text-center bg-red-50 border border-red-200 rounded-lg p-4">
                  ...
                  <div className={`inline-block ${strength.bg} ${strength.color} font-bold text-sm px-2 py-1 rounded-md mb-2`}>
                    {strength.text}
                  </div>
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <div className="text-gray-800 mb-2 text-base">{analysisResult.fiveElements.dominantElement || UI_TEXT.numerology.bazi.resultPage.pillars.notAvailable}</div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-800 mb-2 text-base">{analysisResult.fiveElements.weakElement || UI_TEXT.numerology.bazi.resultPage.pillars.notAvailable}</div>
                  <div className="text-gray-600 text-base">
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-800 mb-2 text-base">{analysisResult.fiveElements.balance || UI_TEXT.numerology.bazi.resultPage.pillars.notAvailable}</div>
                  <div className="text-gray-600 text-base">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              {Object.entries(safeTenGods).map(([key, god]: [string, any]) => {
                ...
                <div key={key} className="bg-red-50 rounded-lg p-4 text-center border border-red-200">
                  ...
                  <div className="text-gray-900 font-bold mb-2 text-base">{cleanName}</div>
                  <div className="text-gray-800 text-base mb-1">{god.element}</div>
                  <div className={`inline-block px-2 py-1 rounded-full text-sm font-medium mb-2 ${getStrengthTagStyle(god.strength)}`}>
                    {god.strength}
                  </div>
                  <div className="text-gray-600 text-base leading-relaxed">{god.meaning}</div>
                </div>
                );
              })}
            </div>
        ...
        {analysisResult.baZi.dayMasterStrength && (
          <Card className="bg-white p-8 mb-8">
            ...
            <div className="bg-red-50 rounded-lg p-6 border border-red-200">
              <div className="text-gray-800 mb-6 text-base leading-relaxed">{analysisResult.baZi.dayMasterStrength.description}</div>
              ...
              <div className="space-y-2">
                {(safeDayMasterStrength.recommendations || []).map((rec: any, index: number) => (
                  <div key={index}>
                    <p className="text-gray-800 text-base leading-relaxed">{rec}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <Card className="bg-white p-8 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                ...
                <p className="text-gray-700 text-base mb-3">These elements bring positive energy and support goals:</p>
                <div className="space-y-2">
                  {(safeFavorableElements.useful || []).map((element: any, index: number) => (
                    <div key={index} className="flex items-center space-x-2">
                      <span className="text-red-400">✓</span>
                      <span className="text-gray-800 text-base">{element}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                ...
                <p className="text-gray-700 text-base mb-3">These elements may create challenges or drain energy:</p>
                <div className="space-y-2">
              ...
              <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                ...
                <p className="text-gray-700 text-base mb-3">These elements neither help nor hinder progress:</p>
                <div className="space-y-2">
        ...
        {(analysisResult.personalityTraits || analysisResult.careerGuidance || analysisResult.wealthAnalysis || analysisResult.relationshipAnalysis || analysisResult.healthAnalysis) && (
          <Card className="bg-white p-8 mb-8">
            ...
            <p className="text-gray-600 text-base mb-6 leading-relaxed">{UI_TEXT.numerology.bazi.resultPage.lifeAnalysisDescription}</p>
                ...
                <div className="bg-red-50 rounded-lg p-6 border border-red-200">
                  <div className="space-y-3">
                    {safePersonalityTraits.map((trait: any, index: number) => (
                      <p key={index} className="text-gray-700 text-base">{trait}</p>
                    ))}
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-red-50 rounded-lg p-4 border border-red-200">
                      <h5 className="text-base font-semibold text-gray-900 mb-2">{UI_TEXT.numerology.bazi.resultPage.marriageTiming}</h5>
                      <p className="text-gray-700 text-base">{analysisResult.relationshipAnalysis.marriageTiming}</p>
                    </div>
                    <div className="bg-red-50 rounded-lg p-4 border border-red-200">
                      <h5 className="text-base font-semibold text-gray-900 mb-2">{UI_TEXT.numerology.bazi.resultPage.partnerCharacteristics}</h5>
                      <p className="text-gray-700 text-base">{analysisResult.relationshipAnalysis.partnerCharacteristics}</p>
                    </div>
                    <div className="bg-red-50 rounded-lg p-4 border border-red-200">
                      <h5 className="text-base font-semibold text-gray-900 mb-2">{UI_TEXT.numerology.bazi.resultPage.marriageAdvice}</h5>
                      <p className="text-gray-700 text-base">{analysisResult.relationshipAnalysis.marriageAdvice}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {analysisResult.healthAnalysis && (
              <div className="mb-8">
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-red-50 rounded-lg p-4 border border-red-200">
                      <h5 className="text-base font-semibold text-gray-900 mb-2">{UI_TEXT.numerology.bazi.resultPage.overallHealth}</h5>
                      <p className="text-gray-700 text-base">{analysisResult.healthAnalysis.overallHealth}</p>
                    </div>
                    <div className="bg-red-50 rounded-lg p-4 border border-red-200">
                      <h5 className="text-base font-semibold text-gray-900 mb-2">{UI_TEXT.numerology.bazi.resultPage.weakAreas}</h5>
                      <div className="space-y-1">
                        {(safeHealthAnalysis.weakAreas || []).map((area: any, index: number) => (
                          <p key={index} className="text-gray-700 text-base">• {area}</p>
                        ))}
                      </div>
                    </div>
                    <div className="bg-red-50 rounded-lg p-4 border border-red-200">
                      <h5 className="text-base font-semibold text-gray-900 mb-2">{UI_TEXT.numerology.bazi.resultPage.healthAdvice}</h5>
                      <div className="space-y-1">
                        {(safeHealthAnalysis.beneficialActivities || []).map((activity: any, index: number) => (
                          <p key={index} className="text-gray-700 text-base">• {activity}</p>
                        ))}
                      </div>
                    </div>
                  </div>
          ...
          <Card className="bg-white p-8 mb-8">
            ...
            <div className="mb-8">
              ...
              <div className="bg-red-50 rounded-lg p-6 border border-red-200">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h5 className="text-base font-semibold text-gray-900 mb-2">{UI_TEXT.numerology.bazi.resultPage.overallFortune}</h5>
                    <p className="text-gray-700 text-base mb-4">{analysisResult?.fortuneAnalysis?.currentYear?.overallDescription}</p>
                  </div>
                  <div>
                    <h5 className="text-base font-semibold text-gray-900 mb-2">{UI_TEXT.numerology.bazi.resultPage.careerProfessionalLife}</h5>
                    <p className="text-gray-700 text-base mb-4">{analysisResult?.fortuneAnalysis?.currentYear?.careerDescription}</p>
                  </div>
                  <div>
                    <h5 className="text-base font-semibold text-gray-900 mb-2">{UI_TEXT.numerology.bazi.resultPage.wealthFinancialMatters}</h5>
                    <p className="text-gray-700 text-base mb-4">{analysisResult?.fortuneAnalysis?.currentYear?.wealthDescription}</p>
                  </div>
                  <div>
                    <h5 className="text-base font-semibold text-gray-900 mb-2">{UI_TEXT.numerology.bazi.resultPage.healthWellbeing}</h5>
                    <p className="text-gray-700 text-base mb-4">{analysisResult?.fortuneAnalysis?.currentYear?.healthDescription}</p>
                  </div>
                  <div>
                    <h5 className="text-base font-semibold text-gray-900 mb-2">{UI_TEXT.numerology.bazi.resultPage.relationshipsSocialLife}</h5>
                    <p className="text-gray-700 text-base mb-4">{analysisResult?.fortuneAnalysis?.currentYear?.relationshipsDescription}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="bg-red-50 rounded-lg p-6 border border-red-200">
                <div className="space-y-4">
                  <div>
                    <h5 className="text-base font-semibold text-gray-900 mb-2">{UI_TEXT.numerology.bazi.resultPage.upcomingTrends}</h5>
                    <p className="text-gray-700 text-base mb-4">{analysisResult?.fortuneAnalysis?.nextYear?.overallDescription}</p>
                  </div>
                  <div>
                    <h5 className="text-base font-semibold text-gray-900 mb-2">{UI_TEXT.numerology.bazi.resultPage.keyAreasOfFocus}</h5>
                    <div className="space-y-1">
                      {((analysisResult?.fortuneAnalysis?.nextYear?.keyTrends) || []).map((trend: any, index: number) => (
                        <p key={index} className="text-gray-700 text-base">• {trend}</p>
                      ))}
                    </div>
                  </div>
                </div>
