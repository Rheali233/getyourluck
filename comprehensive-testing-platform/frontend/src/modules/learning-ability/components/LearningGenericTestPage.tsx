      ...
      <LearningTestContainer>
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between">
            ...
            <button onClick={() => window.location.assign('/tests/learning')} className="inline-flex items-center px-4 py-2 rounded-full bg-white/70 text-sky-900 font-semibold hover:hover:bg-white/80 transition ml-4">
