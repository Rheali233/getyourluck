...
const resources = {
  zh: {
    translation: {
      'hero.title': '🌟 发现真实的自己，遇见更好的未来 🌟',
      'hero.description': '还在为"我是谁？"而困惑吗？想知道什么职业最适合你？通过趣味心理测试和AI智能分析，3分钟get你的性格密码！',
      'features.scientific': '🔬 科学靠谱',
      'features.accurate': '🎯 准到心坎',
      'features.private': '🔒 绝对保密',
      'features.fast': '⚡ 秒出结果',
      'features.accessible': '📱 随时随地',
      'search.title': '🔍 找到最适合你的测试',
      'search.placeholder': '搜索心理测试、性格分析、星座运势...',
      'search.hotKeywords': '热门搜索',
      'cookies.title': '我们使用cookies来改善您的体验',
      'cookies.description': '我们使用cookies来改善您的体验和提供个性化内容',
      'cookies.acceptAll': '接受全部',
      'cookies.necessaryOnly': '仅必要',
      'cookies.customize': '自定义'
    }
  },
  en: {
    translation: {
      'hero.title': '🌟 Discover Your True Self, Meet a Better Future 🌟',
      'hero.description': 'Still confused about "Who am I?" Want to know what career suits you best? Get your personality code in 3 minutes through fun psychological tests and AI analysis!',
      'features.scientific': '🔬 Scientific',
      'features.accurate': '🎯 Accurate',
      'features.private': '🔒 Private',
      'features.fast': '⚡ Instant',
      'features.accessible': '📱 Accessible',
      'search.title': '🔍 Find the Perfect Test for You',
      'search.placeholder': 'Search personality tests, analysis, horoscope...',
      'search.hotKeywords': 'Popular Searches',
      'cookies.title': 'We use cookies to improve your experience',
      'cookies.description': 'We use cookies to improve your experience and provide personalized content',
